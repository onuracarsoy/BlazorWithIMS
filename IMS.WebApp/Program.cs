...
builder.Services.AddAuthorization(options =>
{
        ...
        options.AddPolicy("Inventory", policy => policy.RequireClaim("Department", "InventoryManagament"));
        ...
        options.AddPolicy("Productions", policy => policy.RequireClaim("Department", "ProductionManagament"));
});
...
var connectionString = builder.Configuration.GetConnectionString("IMSAccountConnection");
...
builder.Services.AddDbContextFactory<IMSContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("IMSConnection")));
